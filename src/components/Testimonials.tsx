            ...
            {companies.map((company) => (
              <motion.div
                ...
                whileHover={{
                  scale: 1.1,
                  y: -8,
                  // filter: "invert(1) grayscale(0%)", // Keep logo white but remove grayscale
                  opacity: 1,
                  zIndex: 10,
                  // background: "rgba(251, 191, 36, 1)", // Yellow tint background
                  boxShadow: "0 0 25px rgba(255, 240, 240, 240)", // Bright yellow glow
                  borderRadius: "0.5rem",
                }}
